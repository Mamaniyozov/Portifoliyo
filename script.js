...
const translations = {
  uz: {
    ...
    'about.p3': `Karmed tizimini ishlatish va qo'llab-quvvatlash: tizimdagi xatolarni tuzatish, Postgres ma'lumotlar bazasidan ma'lumotlarni ajratib olish va to'g'rilash, FastReport yordamida tizimdagi hujjatlarni tuzatish, muammoli loyihalarning backend qismi va Telegram-botlarini tiklash, ba'zi hollarda esa loyihani to'liq qayta tiklash.`,
  ...
  ru: {
    ...
    'about.p3': 'Обеспечение работы системы Karmed, что включает в себя: устранение ошибок в системе, извлечение и корректировку отдельных данных из базы данных Postgres, исправление документов в системе с помощью FastReport, восстановление backend-части и Telegram-ботов некоторых проблемных проектов, а в некоторых случаях — восстановление проекта целиком.',
  ...
  tr: {
    ...
    'about.p3': 'Karmed sisteminin bakımı ve işletimi: sistemdeki hataları düzeltrme, Postgres veri tabanından veri çıkarma ve düzeltme, FastReport kullanarak sistemdeki belgeleri düzültme, sorunlu projelerin backend bölümü ve Telegram botlarını yeniden kurma ve bazı durumlarda projenin tamamını yeniden oluşturma.',
  ...
  en: {
    ...
    'about.p3': 'Maintaining and operating the Karmed system: fixing bugs, extracting and correcting data from the Postgres database, fixing documents in the system using FastReport, restoring the backend and Telegram bots of problematic projects, and in some cases — restoring the entire project from scratch.',
