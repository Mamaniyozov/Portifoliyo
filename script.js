...
const translations = {
  uz: {
    ...
    "nav.skills": "Texnik bilimlar",
    "nav.experience": "Tajriba",
    "nav.projects": "Loyihalar",
    "nav.contact": "Bog'lanish",
    "hero.status_sub": "(Aktiv · Remote / Hybrid / On-site)",
    "hero.sub": "SENIOR BACKEND / FULL-STACK ENGINEER",
    "hero.desc": "Django, DRF va ASP.NET texnologiyalari bazasida yuqori yuklamalarga chidamli backend tizimlari va xavfsiz REST API'lar loyihalashtiraman. Ma'lumotlar yaxlitligi, ma'lumotlar bazalari optimizatsiyasi hamda production-ready integratsiyalarga ixtisoslashganman.",
    "hero.cta_projects": "Loyihalarni ko'rish",
    "hero.cta_contact": "Bog'lanish",
    "about.eyebrow": "// ARCHITECTURE & BACKGROUND",
    "about.title": "Men haqimda",
    "about.hello": "Salom, men Muhammadyusuf Mamaniyozov",
    "about.text": "Django va ASP.NET ekotizimida murakkab backend tizimlarini loyihalashtiruvchi muhandisman. Kunlik mas'uliyatim — RESTful API arxitekturasi, PostgreSQL baza sxemalarini normallashtirish va so'rovlarni optimallashtirish, xavfsiz autentifikatsiya mexanizmlari (JWT/2FA) hamda prod-muhitda barqaror ishlaydigan servislar yaratishdir.",
    "about.text_enhanced": "Men Muhammad Yusuf — tizim arxitekturasini loyihalash va murakkab ma'lumotlar bazasi muammolarini (PostgreSQL'da yirik jadvallarni bog'lash, so'rovlar indeksatsiyasi hamda analitik hisobotlarni optimallashtirish) samarali hal etuvchi backend muhandisiman. Tizimli muammolarga chuqur tahlil bilan yondashaman, jamoada junior dasturchilarga ustozlik qilib, ularni mustaqil va arxitektura qoidalariga mos ishlashga yo'naltiraman. Maqsadim — Data Analytics va Full-Stack yo'nalishlarida yetakchilik qilish hamda Senior Engineer / Tech Lead darajasida murakkab muhandislik loyihalarini boshqarish.",
    "about.cv_btn": "Rezyumeni yuklab olish (PDF)",
    "about.github_btn": "GitHub Profil",
    "about.exp_eyebrow": "// METRICS & CAPACITY",
    "about.stat_years": "Tijoriy muhandislik tajribasi",
    "about.stat_projects": "Production va ochiq loyihalar",
    "about.stat_response": "Javob berish tezligi (SLA)",
    "about.mini_text": "Hozirda “RIO va RIATM” Respublika Onkologiya Markazida Karmed Tibbiyot-Axborot Tizimi (HIS) uzluksizligini ta'minlayman: PostgreSQL ma'lumotlar bazasi analitikasi va migratsiyasi, FastReport hisobot tizimlari, Telegram-botlar infratuzilmasi va backend servislarini tiklash.",
    "about.fact_loc_k": "Joylashuv",
    "about.fact_loc_v": "Samarqand, O'zbekiston · UTC+5",
    "about.fact_lang_k": "Tillar",
    "about.fact_lang_v": "O'zbek (ona tili) · Rus (erkin) · Ingliz (texnik)",
    "about.fact_avail_k": "Formati",
    "about.fact_avail_v": "Remote / Hybrid / On-site · Full-time / Contract",
    "about.contact_link": "Hamkorlik uchun bog'lanish",
    "skills.eyebrow": "// TECH STACK & ENGINE",
    "skills.title": "Texnik ko'nikmalar",
    "skills.lede": "Abstrakt foizlar o'rniga — real production loyihalarda qo'llanilgan arxitektura va vositalar.",
    "skills.name.api": "REST API & Mikroservislar Arxitekturasi",
    "skills.name.auth": "Xavfsizlik & Auth — JWT / 2FA / OTP / OAuth2",
    "skills.ctx.django": "HRMM · Doctor-Direct · LadyCoders · Finance Ecosystem",
    "skills.ctx.python": "Asinxron va sinxron backend mantiq, optimallash skriptlari, servislar",
    "skills.ctx.pg": "Relatsion DB sxemalari, indeksatsiya, EXPLAIN tahlili va migratsiyalar",
    "skills.ctx.api": "API versiyalash, RBAC ruxsatlar, OpenAPI / Swagger spetsifikatsiyasi",
    "skills.ctx.auth": "SimpleJWT, token revocation (blacklist), audit logging tizimlari",
    "skills.ctx.tg": "Ecosystem botlari, xatolikka chidamli xabarnoma servislarini tiklash",
    "skills.ctx.aspnet": "Karmed HIS tizimi backend-mantiqini qo'llab-quvvatlash va refaktoring",
    ...
    "exp.rio.role": "Backend Support & Database Engineer",
    "exp.rio.text": "Karmed Tibbiy-Axborot Tizimi (HIS) barqarorligini ta'minlash: PostgreSQL bazasidagi yirik jadvallar analitikasi va tuzatishlar, FastReport hisobot formalarini optimallashtirish hamda servis botlarini qayta tiklash. Tizim tibbiyot xodimlari tomonidan 24/7 rejimida ishlatilgani sababli har bir reliz yuqori darajada sinovdan o'tkaziladi.",
    "exp.freelance.date": "2023 — 2025",
    "exp.freelance.role": "Full-Stack Software Engineer (Freelance)",
    "exp.freelance.text": "Murakkab axborot tizimlarini noldan boshlab loyihalashtirish: biznes talablarini tahlil qilish, relatsion DB sxemalarini tuzish, Django/DRF backend-ini yaratish hamda produksiyaga joylash va kuzatib borish.",
    "exp.edu.date": "2025",
    "exp.edu.role": "Bakalavr — Axborot Texnologiyalari Muhandisligi",
    "exp.edu.text": "Axborot Texnologiyalari Muhandisligi bo'yicha oliy ma'lumot.",
    ...
    "proj.hrmm.kind": "ENTERPRISE HRMS PLATFORM",
    "proj.hrmm.problem": "Xodimlar ma'lumotlari, davomat va ta'tillar tarqoq jadval va qog'ozlarda yuritilardi. Oylik analitika va audit o'tkazish imkonsiz edi.",
    "proj.hrmm.solution": "Django + DRF bazasida markazlashgan HRMS arxitekturasi qurildi: xodimlar reyestri, davomat, ta'til workflow'lari va avtomatik analitika. Telegram Bot va JWT + 2FA/OTP autentifikatsiyasi hamda to'liq Audit Trail jurnali joriy etildi.",
    "proj.hrmm.result": "HR-jarayonlar to'liq raqamlashtirildi: hisobotlar 0 soniyada shakllanadi, audit loglar orqali ma'lumotlar xavfsizligi kafolatlandi.",
    "proj.finance.kind": "FINANCIAL ENGINE & MOBILE APP",
    "proj.finance.problem": "Shaxsiy moliyaviy oqimlar turli ilovalarga bo mezonlarsiz bo'lingan bo'lib, oylik balans va jamg'armalarni tahlil qilish imkoni yo'q edi.",
    "proj.finance.solution": "Django REST Framework backend-i va Flutter mobil ilovasi. Kategoriyalangan xarajatlar analitikasi, oylik hisobot va maqsadli jamg'arma modullari. API SimpleJWT bilan himoyalangan, testlar Pytest bilan ta'minlangan.",
    "proj.finance.result": "Moliya kiritish va oylik analitika olish to'liq avtomatlashtirildi, hisob-kitob xatoliklari bartaraf etildi.",
    "proj.doctor.kind": "HEALTHCARE ROUTING & COMMUNICATION API",
    "proj.doctor.problem": "Tibbiyot muassasasida bemorlar navbati va shifokorlar muloqoti an'anaviy qog'oz varaqalari orqali olib borilib, navbatlar xaosiga olib kelardi.",
    "proj.doctor.solution": "Rollarga asoslangan (RBAC) REST API: mutaxassisliklar bo'yicha navbat algoritmlari, real-time muloqot va avtomatik PDF generator. OpenAPI/Swagger bilan to'liq hujjatlashtirilgan.",
    "proj.doctor.result": "Barcha navbatlar va kommunikatsiya yagona API platformasiga ko'chirildi; hisobotlar avtomatik PDF formatida shakllantiriladi.",
    "proj.lady.kind": "EDTECH LMS PLATFORM",
    "proj.lady.problem": "Ta'lim kursi progressi, modul topshiriqlari va sertifikatlarni berish jarayoni qo'lda bajarilib, katta vaqt talab etardi.",
    "proj.lady.solution": "Kurs-modul ierarxiyasiga ega LMS backend-i: avtomatik o'zlashtirish progressi, yangiliklar stream-i hamda avtomatik sertifikat generatsiyasi. Xavfsiz JWT Blacklist mexanizmi joriy qilindi.",
    "proj.lady.result": "O'quvchilar progressi va sertifikatsiyalash 100% avtomatlashtirildi.",
    "proj.view_project": "Loyihani ko'rish",
    "proj.view_github": "GitHub Repozitoriyasi",
    "contact.eyebrow": "// GET IN TOUCH",
    "contact.title": "Bog'lanish",
    "contact.headline": "Keling, yangi muhandislik yechimlarini birga quramiz",
    "contact.cta_telegram": "Telegram orqali bog'lanish",
    "contact.email": "Elektron pochta",
    "contact.phone": "Telefon raqami",
    "contact.text": "Yangi loyiha, muhandislik vakansiyasi yoki texnik konsultatsiya bo'yicha yozing. 24 soat ichida aloqaga chiqaman.",
    "form.eyebrow": "// DIRECT MESSAGE",
    "form.title": "To'g'ridan-to'g'ri xabar yuborish",
    "form.name": "Ismingiz",
    ...
    "form.ph_email": "ismingiz@kompaniya.uz",
    "form.ph_message": "Loyiha, vazifa yoki hamkorlik haqida qisqacha…",
    "form.err_name": "Iltimos, ismingizni kiriting.",
    "form.err_email": "To'g'ri email manzilni kiriting.",
    "form.err_message": "Xabaringizni yozing (kamida 10 ta belgi).",
  ...
  en: {
    ...
    "about.text_enhanced": "I'm Muhammad Yusuf — a backend engineer with deep expertise in system architecture and complex database challenges, including joining large PostgreSQL tables and optimising analytical reporting queries. I approach every problem systematically, mentor junior developers toward independent work, and guide them through solving hard problems. My aim is to grow into data analytics and full-stack engineering, and ultimately lead an engineering team as a senior engineer.",
  ...
  ru: {
    ...
    "about.text_enhanced": "Я Мухаммад Юсуф — backend-разработчик с глубоким опытом в проектировании системной архитектуры и решении сложных задач баз данных: объединение больших таблиц PostgreSQL, оптимизация аналитических запросов и отчётности. Решаю задачи системно, обучаю начинающих разработчиков самостоятельной работе и наставляю их в процессе решения сложных проблем. Цель — развитие в направлении анализа данных и full-stack разработки, а в перспективе — роль senior-разработчика и руководителя команды.",
