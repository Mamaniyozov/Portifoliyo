...
const translations = {
  uz: {
    ...
    "about.text_enhanced": "Men Muhammad Yusuf. Tizim arxitekturasini loyihalash va murakkab ma'lumotlar bazasi muammolarini, jumladan PostgreSQL orqali katta jadvallarni ulash va hisobotlarni optimallashtirgish bo'yicha kuchli tajribaga ega backend dasturchiman. Hozirgi ishimda sistemadagi barcha ma'lumotlarni hal qilishga tizimli yondashaman, shogirdlarni mustaqil ishlashga tayyorlash va murakkab muammolarni hal qilish jarayonida ularga ustozlik qilganman. Ma'lumotlar tahlili va full-stack yo'nalishlarida rivojlanishni, kelajakda senior dasturchi va jamoa rahbari bo'lishni maqsad qilganman.",
